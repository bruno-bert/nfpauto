...
def save_config():
 ...
 cursor.execute("INSERT INTO config_arquivo (cnpj, id_text, nome, delimitador, tipo, coluna, nome_coluna, header, sheet_name)  VALUES (?,?,?,?,?,?,?,?,?)",  ('*', 'EXCEL_HEADER', 'Excel com Header', '', 'excel', '4','Chave','1' , 'main' ) )
