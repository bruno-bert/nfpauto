...
class Ui_MainWindow(QObject):
    ...
    def setupUi(self, MainWindow):
        ...
        self.btn_login.setGeometry(QRect(1330, 20, 271, 41))
        font = QFont()
        ...
        self.btn_cnpj.setGeometry(QRect(1610, 20, 271, 41))
        font = QFont()
        font.setFamily("Arial")
        font.setPointSize(14)
        font.setBold(True)
        ...
        icon10 = QIcon()
        icon10.addPixmap(QPixmap("assets/icons/play1.png"), QIcon.Normal, QIcon.Off)
        self.btn_iniciar_postagem.setIcon(icon10)
        self.btn_iniciar_postagem.setIconSize(QSize(32, 32))
        self.btn_iniciar_postagem.setObjectName("btn_iniciar_postagem")
        icon11 = QIcon()
        icon11.addPixmap(QPixmap("assets/icons/ai.png"), QIcon.Normal, QIcon.Off)
...
"</h2>"))
        ...
        self.toolBox.setItemText(self.toolBox.indexOf(self.page_2), _translate("MainWindow", "      Postagem de Notas (Parado)"))
